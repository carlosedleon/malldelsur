...
<html lang="es">
<head>
    <title>Inicio | Mall del Sur</title>
    <?php include './inc/link.php'; ?>
</head>
<body id="container-page-index">
    <?php include './inc/navbar.php'; ?>
    <div class="jumbotron" id="jumbotron-index">
      <h1><span class="tittles-pages-logo">Mall del Sur</span> <small style="color: #fff;">Costa Rica</small></h1>
      <p>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:20%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrese y hagase cliente de <span class="tittles-pages-logo">Mall del Sur</span> para recibir las mejores ofertas y descuentos especiales de nuestros productos.</p>
