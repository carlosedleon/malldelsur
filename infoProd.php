...
-Jonathan Marchena: Desarollador
-Carlos León: Desarrollador
-Fernanda León: Diseñadora
-Olman Arias: Base de datos
        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                    <h1>Tienda <small class="tittles-pages-logo">Mall del Sur</small></h1>
                </div>
                <?php 
